        ...
        <div className="container">
          <div className="row gy-4">
            <div className="col-lg-5 col-md-12 footer-info">
              ...
              <p>
                Cars fermentum odio eu feugiat lide par naso tierra. Justo eget
                hada terra videa magna derita valies darta donna mare fermentum
            ...
            <div className="col-lg-3 col-md-12 footer-contact text-center text-md-center">
              <h4>Contact Us</h4>
              <p>
                Street Name <br />
